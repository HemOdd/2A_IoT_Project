 ...
 ****************************************/
namespace {
    const char * WIFISSID = "SunwayNet WIFI"; //Put your WifiSSID here
//    const char * PASSWORD = "Assign_your_wifi_SSID_here"; // Put your wifi password here
    const char * TOKEN = "Computer_Science_Project2_2A"; // Put your Ubidots' TOKEN
    const char * MQTT_CLIENT_NAME = "mqtt.eclipse.org"; // MQTT client Name, please enter your own 8-12 alphanumeric character ASCII string; 
...
void loop() {
    ...
    client.publish("sensor1", payload);
    client.loop();
    delay(1000);
}
